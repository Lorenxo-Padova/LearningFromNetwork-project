...
Based on Kipf et al. (2017) - https://arxiv.org/abs/1609.02907
"""
import numpy as np
import torch
...
class GCNModel(nn.Module):
    """
    Graph Convolutional Network model for node embedding.
    """
...
class GCNEmbedder(BaseEmbedder):
    """
    GCN implementation for graph embedding using Graph Convolutional Networks.
    """
    ...
    def generate_embeddings(self, graph):
        """
        Generate GCN embeddings for all nodes in the graph.
    ...
    def __str__(self):
        return (f"GCN(dim={self.embedding_dim}, "
