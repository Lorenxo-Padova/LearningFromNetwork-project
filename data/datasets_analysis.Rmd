...
CTD_all_disease <- CTD_all_disease[!is.na(all_terms)]

CTD_mesh_disease <- all_terms[grep("^MESH:", CTD_all_disease)]
CTD_mesh_disease <- length(unique(CTD_mesh_disease))
print(paste("Total unique MESH:", CTD_mesh_disease))

CTD_omim <- all_terms[grep("^OMIM:", CTD_all_disease)]
...
```{r, edge-table, echo=FALSE, out.width="70%", fig.align="center", fig.cap="Number of nodes by type and identifier"}
